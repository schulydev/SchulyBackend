...
API reference (Scalar): <http://localhost:5033/scalar> — OpenAPI doc still generated by Swashbuckle at `/swagger/v1/swagger.json` (the Dart client is generated from it).
