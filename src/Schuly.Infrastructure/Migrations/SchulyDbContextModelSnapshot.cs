...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Schuly.Domain.AgendaEntry", b =>
                {
                    ...
                    b.ToTable("AgendaEntries", t =>
                        {
                            t.HasCheckConstraint("CK_AgendaEntry_EndDateAfterDate", "\"EndDate\" IS NULL OR \"EndDate\" >= \"Date\"");
            ...
            modelBuilder.Entity("Schuly.Domain.DeviceToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Schuly.Domain.NotificationOutbox", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Schuly.Domain.NotificationPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<bool>("Absences")
                        .HasColumnType("boolean");

                    b.Property<bool>("Agenda")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("IncludeGradeValue")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Schuly.Domain.SchoolSystem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PluginBasePath")
                        .HasColumnType("text");

                    b.Property<string>("PrivateAuthStrategy")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.Property<string>("StatelessBasePath")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Schuly.Domain.SchoolUser", b =>
                {
                    ...
                    b.HasIndex("ApplicationUserId", "SchoolId", "Email")
                        .IsUnique();
            ...
            modelBuilder.Entity("Schuly.Domain.SchoolSystem", b =>
                {
                    b.OwnsMany("Schuly.Domain.SchoolSystemLoginField", "LoginFields", b1 =>
                        {
                            b1.Property<Guid>("SchoolSystemId");
                            ...
                            b1.HasKey("SchoolSystemId", "__synthesizedOrdinal");

                            b1.ToTable("SchoolSystems");
                            ...
                            b1.WithOwner()
                                .HasForeignKey("SchoolSystemId");
                        });

                    b.Navigation("LoginFields");
                });
